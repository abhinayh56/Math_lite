...
template <typename T>
constexpr DualQuaternion<T>::DualQuaternion(const Quaternion<T> &real, const Quaternion<T> &dual) : real(real), dual(dual)
{
}

template <typename T>
constexpr DualQuaternion<T>::DualQuaternion(T r0, T r1, T r2, T r3, T d0, T d1, T d2, T d3) : real(r0, r1, r2, r3), dual(d0, d1, d2, d3)
{
}
...
inline constexpr DualQuaternion<T> DualQuaternion<T>::from_translation(T x, T y, T z)
{
    ...
    return DualQuaternion<T>(Quaternion<T>::identity(), Quaternion<T>::mul(translation, Quaternion<T>::identity()));
}
...
{
    Quaternion<T> translation(0, x / 2, y / 2, z / 2);
    return DualQuaternion<T>(rotation, Quaternion<T>::mul(translation, rotation));
}

template <typename T>
inline constexpr DualQuaternion<T> DualQuaternion<T>::add(const DualQuaternion<T> &dq1, const DualQuaternion<T> &dq2)
{
    return DualQuaternion<T>(Quaternion<T>::add(dq1.real, dq2.real), Quaternion<T>::add(dq1.dual, dq2.dual));
}

template <typename T>
inline constexpr DualQuaternion<T> DualQuaternion<T>::sub(const DualQuaternion<T> &dq1, const DualQuaternion<T> &dq2)
{
    return DualQuaternion<T>(Quaternion<T>::sub(dq1.real, dq2.real), Quaternion<T>::sub(dq1.dual, dq2.dual));
}

template <typename T>
inline constexpr DualQuaternion<T> DualQuaternion<T>::mul(const DualQuaternion<T> &dq1, const DualQuaternion<T> &dq2)
{
    return DualQuaternion<T>(Quaternion<T>::mul(dq1.real, dq2.real), Quaternion<T>::add(Quaternion<T>::mul(dq1.real, dq2.dual), Quaternion<T>::mul(dq1.dual, dq2.real)));
}

template <typename T>
inline constexpr DualQuaternion<T> DualQuaternion<T>::mul(const DualQuaternion<T> &dq, T s)
{
    return DualQuaternion<T>(Quaternion<T>::mul(dq.real, s), Quaternion<T>::mul(dq.dual, s));
}
...
{
    return DualQuaternion<T>(Quaternion<T>::div(dq.real, s), Quaternion<T>::div(dq.dual, s));
}

template <typename T>
inline constexpr DualQuaternion<T> DualQuaternion<T>::conj(const DualQuaternion<T> &dq)
{
    return DualQuaternion<T>(Quaternion<T>::conj(dq.real), Quaternion<T>::conj(dq.dual));
}
...
inline constexpr DualQuaternion<T> DualQuaternion<T>::inv(const DualQuaternion<T> &dq)
{
    ...
    return DualQuaternion<T>(real_inv, Quaternion<T>::mul(Quaternion<T>::mul(real_inv, Quaternion<T>::mul(dq.dual, real_inv)), T(-1)));
}
...
inline constexpr DualQuaternion<T> DualQuaternion<T>::exp(const DualQuaternion<T> &dq)
{
    ...
    return DualQuaternion<T>(exp_real, Quaternion<T>::mul(exp_real, dq.dual));
}
...
inline constexpr DualQuaternion<T> DualQuaternion<T>::log(const DualQuaternion<T> &dq)
{
    ...
    return DualQuaternion<T>(log_real, Quaternion<T>::mul(Quaternion<T>::mul(Quaternion<T>::inv(dq.real), dq.dual), T(1)));
}
                                                              ...
                                                              T &moment_x, T &moment_y, T &moment_z)
{
    ...
    {
        pitch = T(2) * (-dq.dual.q0 * dq.real.q1 + dq.real.q0 * dq.dual.q1 - dq.dual.q2 * dq.real.q3 + dq.dual.q3 * dq.real.q2) / angle;
    }

    // Calculate moment vector
    moment_x = T(2) * (-dq.dual.q0 * dq.real.q1 + dq.real.q0 * dq.dual.q1 - dq.dual.q2 * dq.real.q3 + dq.dual.q3 * dq.real.q2);
    moment_y = T(2) * (-dq.dual.q0 * dq.real.q2 + dq.real.q0 * dq.dual.q2 - dq.dual.q3 * dq.real.q1 + dq.dual.q1 * dq.real.q3);
    moment_z = T(2) * (-dq.dual.q0 * dq.real.q3 + dq.real.q0 * dq.dual.q3 - dq.dual.q1 * dq.real.q2 + dq.dual.q2 * dq.real.q1);
}

template <typename T>
inline constexpr DualQuaternion<T> DualQuaternion<T>::LERP(const DualQuaternion<T> &dq1, const DualQuaternion<T> &dq2, T tau)
{
    return add(mul(dq1, T(1) - tau), mul(dq2, tau));
}

template <typename T>
inline constexpr DualQuaternion<T> DualQuaternion<T>::SLERP(const DualQuaternion<T> &dq1, const DualQuaternion<T> &dq2, T tau)
{
    return mul(dq1, pow(mul(inv(dq1), dq2), tau));
}

template <typename T>
inline constexpr DualQuaternion<T> DualQuaternion<T>::ScLERP(const DualQuaternion<T> &dq1, const DualQuaternion<T> &dq2, T tau)
{
    ...
    Quaternion<T> trans = Quaternion<T>(T(0), d * dx, d * dy, d * dz);
