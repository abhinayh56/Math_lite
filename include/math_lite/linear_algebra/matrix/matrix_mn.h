...
public:
    ...
    static inline constexpr MatrixMN<T, M, N> trans(const MatrixMN<T, M, N> &M1);
    static inline constexpr T det(const MatrixMN<T, M, N> &M1);
    static inline constexpr T trace(const MatrixMN<T, M, N> &M1);
    static inline constexpr MatrixMN<T, M, N> minor(const MatrixMN<T, M, N> &M1);
    static inline constexpr MatrixMN<T, M, N> cofactor(const MatrixMN<T, M, N> &M1);
    static inline constexpr MatrixMN<T, M, N> adj(const MatrixMN<T, M, N> &M1);
    static inline constexpr MatrixMN<T, M, N> inv(const MatrixMN<T, M, N> &M1);
